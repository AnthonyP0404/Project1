    ...
    <div id="navbar" data-testid="navbar">
      <BrowserRouter>
        <Navbar expand="lg" className="bg-body-tertiary">
          <Container>
            <Navbar.Brand>
              <img id="QAlogo" src={QAlogo} alt="QA" />{" "}
              <i style={{ fontSize: "15px" }}>Estate Agent</i>{" "}
            </Navbar.Brand>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="me-auto">
                ...
                <Nav.Link as={Link} to={"./buyersPage"}>
                  {" "}
                  <span id="nav-item">
                    {" "}
                    <b>Buyers </b>{" "}
                ...
                <Nav.Link as={Link} to={"./propertiesPage"}>
                  {" "}
                  <span id="nav-item">
                    {" "}
                    <b>Properties </b>{" "}
        ...
        <Routes>
          ...
          <Route
            path="/sellersPage/registerSeller"
            element={<RegisterSeller />}
          />

          <Route path="/propertiesPage" element={<PropertiesPage />} />
          <Route
            path="/propertiesPage/submitProperty"
            element={<SubmitProperty />}
          />
          <Route
            path="/propertiesPage/filterProperties"
            element={<FilterProperties />}
          />
          <Route
            path="/propertiesPage/viewProperty"
            element={<ViewProperty />}
          />
          <Route
            path="/propertiesPage/viewProperty/ammendProperty"
            element={<AmmendProperty />}
          />
        </Routes>
      </BrowserRouter>
    </div>
